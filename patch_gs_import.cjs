...
const targetReplacement = `  setLocalData('fin_budgets', parsedBudgets);
  setLocalData('fin_goals', parsedGoals);`;

const newCode = `  setLocalData('fin_budgets', parsedBudgets);
  setLocalData('fin_goals', parsedGoals);
...
content = content.replace(targetReplacement, newCode);
