    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <Button 
          ...
          size="sm"
          className="h-9 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-indigo-500/20 gap-2"
        >
                ...
                <form onSubmit={handleCreate} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2 flex flex-col justify-end">
                      <div className="flex items-center justify-between p-3 h-11 bg-indigo-500/5 rounded-xl border border-indigo-500/20">
                        <Label className="text-[10px] font-black uppercase tracking-widest text-indigo-600">Vincular a Custos Fixos</Label>
                        <Switch 
                  ...
                  <div className="flex flex-col sm:flex-row gap-6">
                    ...
                    <div className="flex items-end gap-3">
                      <Button type="submit" className="h-11 px-8 bg-indigo-600 hover:bg-indigo-700 text-white text-[10px] font-black uppercase tracking-widest rounded-xl shadow-lg shadow-indigo-500/20">
                        Registar Despesa
                      </Button>
                    </div>
                  </div>
                ...
                <Card className="group border-none shadow-sm bg-card/50 rounded-2xl overflow-hidden hover:shadow-md transition-all duration-300">
                  <div className="p-5 flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-transform group-hover:scale-110 duration-500 ${
                      ...
                      exp.category === 'Seguro Multirriscos' ? 'bg-indigo-500/10 text-indigo-600' :
