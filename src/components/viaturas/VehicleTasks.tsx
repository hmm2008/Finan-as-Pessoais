...
import { Plus, Wrench, CheckCircle2, AlertTriangle, FileText, Trash2, Edit, Download } from 'lucide-react';
      ...
      <div className="space-y-3">
        {filteredTasks.length === 0 ? (
          ...
          filteredTasks.map(task => (
            <Card key={task.id} className={`transition-all ${task.status === 'concluída' ? 'opacity-70 bg-secondary/20' : 'border-border'}`}>
