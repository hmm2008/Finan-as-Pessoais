    ...
    await fetch(`https://sheets.googleapis.com/v4/spreadsheets/${spreadsheetId}/values:batchUpdate`, {
      ...
      body: JSON.stringify({
        ...
        data: [
          ...
          { range: 'Despesas_Fixas!A1:O1', values: [["ID", "Nome", "Entidade", "Categoria", "Valor (€)", "Dia Vencimento", "Frequência", "Método", "Ativo", "Veículo", "Notas", "Data Início", "Data Fim", "Observações", "Próximo Vencimento"]] },
          ...
          { range: 'Patrimonio!A1:K1', values: [["ID", "Nome", "Categoria / SubTipo", "Valor Atual (€)", "Valor Compra (€)", "Data Aquisição", "Rua", "Código Postal", "Localidade", "Notas", "Custos Fixos Detalhados (JSON)"]] },
