...
import { usePin, usePreferences, usePrivacy } from '../../contexts';
...
export function Layout() {
  ...
  return (
    <div className={`flex h-screen overflow-hidden bg-background ${privacyMode ? 'privacy-active' : ''}`}>
      ...
      <div className="flex flex-1 flex-col overflow-hidden min-w-0">
        ...
        >
          <div className="max-w-7xl mx-auto p-4 sm:p-6 w-full pb-24 md:pb-8">
