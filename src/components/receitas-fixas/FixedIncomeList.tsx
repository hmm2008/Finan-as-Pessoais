                      ...
                      <div className="group relative">
                        ...
                        >
                          ...
                          {uniqueRegisteredMonths.length > 0 && (
                            <span 
                              className="flex items-center justify-center min-w-[16px] h-4 ml-0.5 px-1 rounded-full bg-emerald-600 text-white text-[10px] font-bold cursor-help sm:cursor-default"
                              onClick={(e) => {
